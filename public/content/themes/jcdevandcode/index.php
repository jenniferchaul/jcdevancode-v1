...
<section id="services" class="services">
    ...
    <div class="container-services">
        ...
        <div class="first-row">
            ...
            <a class="card-services vitrine grey" href="<?= home_url('/sites-vitrine') ?>">
        ...
        <div class="second-row">
            ...
            <a class="card-services ecommerce white" href="<?= home_url('/sites-ecommerce') ?>">
            ...
            <a class="card-services seo grey" href="<?= home_url('/seo') ?>">
            ...
            <a class="card-services branding white" href="<?= home_url('/branding') ?>">
